...
// For deployment (e.g., on Netlify), it will connect to the public backend URL.
// You will replace 'YOUR_BACKEND_URL_HERE' with the actual URL from your hosting provider (e.g., Railway).
const backendUrl = window.location.hostname === 'localhost' || window.location.hostname === '192.168.43.150'
  ? 'http://localhost:3001'
  : 'http://192.168.43.150:3001'; // <--- تم التعديل للاتصال بالسيرفر المحلي

const socket = io(backendUrl);

// DOM elements (يجب أن تكون معرفة مرة واحدة فقط)
